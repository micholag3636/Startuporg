...
function Services() {
    return (
        <div>
               <h1 className="main-titles">Our Services</h1>
        <div className="all-services">

            
     
            <Productscreen title="Web Hosting" text="We supply amazon web services for our clients" img="https://www.elegantthemes.com/blog/wp-content/uploads/2020/01/difference-between-domain-and-web-hosting-featured-image.jpg"/>
